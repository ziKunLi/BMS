      ...
      <tr>
        ...
        <td><table width="100%" height="131"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <form name="form1" method="post" action="bookType_modify.action">
 				<input name="id" type="hidden" size="50" value="<s:property value="bookType.id"/>"> 
  				<table width="100%" height="111" border="0" cellpadding="0" cellspacing="0">
  					<tr>
    					<td width="29%" align="center">类型名称：      </td>
    					<td width="71%">
    					<input name="typeName" type="text" size="30" value="<s:property value="bookType.typeName"/>"></td>
  					</tr>
		  		<tr>
		    		<td align="center">可借天数：</td>
		    		<td><input name="days" type="text" size="25" value="<s:property value="bookType.days"/>">(天)</td>
		  		</tr>
		  		<tr>
		    		<td>&nbsp;</td>
		    		<td>
