  ...
  <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <td height="35"><input name="name" type="text" value=""></td>
      </tr>
      <tr>
        <td height="30" align="center">条&nbsp;形&nbsp;码：</td>
        <td><input name="barcode" type="text" id="barcode" value=""></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="paperType" type="text" value=""></td>
      </tr>
      <tr>
        <td height="30" align="center">证件号码：</td>
        <td><input name="paperNO" type="text" id="paperNO" value=""></td>
      </tr>
      <tr>
        <td height="30" align="center">登记日期：</td>
        <td><input name="paperNO2" type="text" id="paperNO2" value=""></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="operator" type="text" id="operator" value="">
          </td>
      </tr>	  
      <tr>
