			...
			<td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><table width="100%" height="131" border="0"
								...
								<tr>
									<td align="center">
										<form name="form1" method="post" action="bookType_add.action">
											<table height="100" border="0" cellpadding="0"
												cellspacing="0" bgcolor="#FFFFFF">
												<tr>
													<td width="77" align="center">类型编号：</td>
													<td width="198" height="39"><input name="bookType.id"
														type="text" size="30"></td>
												</tr>
												<tr>
													<td width="77" align="center">类型名称：</td>
													<td width="198" height="39"><input name="bookType.typeName"
														type="text" size="30"></td>
												</tr>
												<tr>
													<td width="77" align="center">可借天数：</td>
													<td height="35"><input name="bookType.days" type="text"
												...
												<tr>
													...
													<td><input name="Submit" type="submit"
														...
														class="btn_grey" value="关闭" onClick="history.back(-1)"></td>
												</tr>
											</table>
										</form>
									</td>
