 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
...
</table>  <form name="form1" method="post" action="parameter_modify.action">
  ...
  <tr align="center">
    ...
    <td width="76%" align="left">
      	<input name="parameter.cost" type="text" id="cost" size="30" value="<s:property value="parameter.cost"/>">(元)</td>
    <tr>
    <td align="left" style="padding:5px;">有效期限：</td>
    <td align="left">
    	<input name="parameter.validity" type="text" id="validity" size="30" value="<s:property value="parameter.validity"/>">(月)</td>
    </tr>
    <tr>
