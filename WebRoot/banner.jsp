...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="118" valign="top" background="Images/top_bg.gif" bgcolor="#C0C0C0"><table width="100%" height="33"  border="0" cellpadding="0" cellspacing="0">
      <tr>
      ...
      <table width="93%" height="79"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="69" align="right" valign="bottom">当前登录用户：<%=StaticDataPool.LOGIN_NAME %></td>
        </tr>
    </table></td>
  </tr>
</table>
